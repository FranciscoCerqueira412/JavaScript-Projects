    ...
    fetch(
        ...
        .then((json) => {
            ...
            if (hoursCountry == "-9") {
                ...
                Math.floor(
                    (time.innerHTML =
                        formatHours(hoursCountry) + ":" + formatHours(minutestoday))
                );
            }
            ...
            streetview.src =
                "https://www.google.com/maps/embed/v1/view?key=AIzaSyBksX_TcLukUuLk_KlR7dsru24SWb3EBGg&&&center=" +
                mapsLat +
                "," +
                mapsLon +
